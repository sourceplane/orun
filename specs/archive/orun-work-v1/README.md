# Spec: orun-work (v1 — ARCHIVED)

> **Superseded.** This is the frozen v1 design, kept as a historical snapshot.
> The authoritative spec is [`specs/orun-work/`](../../orun-work/) (v2), which
> replaces the stored-status ontology with lifecycle-as-derived-query over two
> append-only logs. The v1 cores (`internal/work`, `internal/workbridge`,
> orun-cloud `@saas/db/work` + migration `200_work_foundation`) were removed
> from both repos when this was archived. See `specs/archive/README.md`.
