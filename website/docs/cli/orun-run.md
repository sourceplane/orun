...
With no flags, `run` resolves the latest plan from `.orun/plans/latest.json` and executes it.
...
| Value | Resolves to |
| --- | --- |
| _(omitted)_ | `.orun/plans/latest.json` |
| `latest` | `.orun/plans/latest.json` |
| `my-plan` | `.orun/plans/my-plan.json` |
