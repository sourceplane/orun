...
go run ./cmd/releaser \
  ...
  --dist ../../dist \
  --output ../../oci \
  --ref ghcr.io/sourceplane/orun:<tag>
```
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o dist/linux_amd64/entrypoint ./cmd/orun
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -o dist/linux_arm64/entrypoint ./cmd/orun
CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -o dist/darwin_amd64/entrypoint ./cmd/orun
CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -o dist/darwin_arm64/entrypoint ./cmd/orun
